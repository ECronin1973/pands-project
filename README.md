...
I followed a similar approach to that outlined in other repositories[15].  The first part of the project entailed researching the methods which would be implemented, and importing the necessary libraries into the python file which would be used to meet the aims and objectives of this project. The iris dataset was downloaded online as a .csv file titled fishers_iris_dataset.csv and saved into the pands-project folder. 
...
1. Abhishek Gupta's analysis of the Fisher Dataset on kaggle.com (https://www.kaggle.com/abhishekkrg/python-iris-data-visualization-and-explanation)
2. ATU Lectures - Programming & Scripting, Dr. Andrew Beatty (https://vlegalwaymayo.atu.ie/course/view.php?id=6208)
3. Creating tables in markdown (https://www.makeuseof.com/tag/create-markdown-table/)
4. CSV file of Fisher's Dataset Downloaded from GitHub User Content (https://raw.githubusercontent.com/uiuc-cse/data-fa14/gh-pages/data/iris.csv)
5. Edukast's Youtube video on Machine Learning Classification - specifically using Fisher's Iris Dataset (https://youtu.be/f3ZJbTyz_pU)
6. Exploritory Data Analysis on Iris Dataset (https://www.geeksforgeeks.org/exploratory-data-analysis-on-iris-dataset/)
7. Kozak, M., Lotocka, B. (2013) 'What should we know about the famous Iris data?' CURRENT SCIENCE, VOL. 104, NO. 5. Available at: https://www.researchgate.net/profile/Marcin_Kozak/publication/237010807_What_should_we_know_about_the_famous_Iris_data/links/02e7e51be9229f3495000000.pdf Accessed on: 07.05.2023.
8. Prateek, S. (2019) "KDE Plot Visualization with Pandas and Seaborn" Geeks For Geeks. Available at: https://www.geeksforgeeks.org/kde-plot-visualization-with-pandas-and-seaborn/ Accessed on: 07.05.2023
9. Source Fisher, R.A. (1936). The use of multiple measurements in taxonomic problems. Ann. Eugenics 7, Pt. II, 179-188. (https://link.springer.com/chapter/10.1007/978-1-4612-5098-2_2)
10. The Problem of Species in the Northern Blue Flags, Iris versicolor L. and Iris virginica L. (https://www.jstor.org/stable/2394087?origin=crossref)
